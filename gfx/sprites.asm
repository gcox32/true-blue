...
BlueBikeSprite::         INCBIN "gfx/sprites/bluecycling.2bpp" ; red_bike.2bpp
BlueSprite::             INCBIN "gfx/sprites/blue.2bpp" ;swapped
RedSprite::              INCBIN "gfx/sprites/red.2bpp" ;swapped
